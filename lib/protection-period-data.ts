...
export interface ProtectedFish {
  ...
  protectionStart: string; // Formát pro zobrazení (např. "1. ledna")
  protectionEnd: string; // Formát pro zobrazení (např. "15. června")
}
...
export const protectedFishData: ProtectedFish[] = [
  // Od 1. ledna do 15. června
  {
    ...
    protectionStart: '1. ledna',
    protectionEnd: '15. června'
  },
  {
    id: 'candat-obecny',
    name: 'candát obecný',
  ...
  // Od 1. září do 30. listopadu
  {
    ...
    protectionStart: '1. září',
    protectionEnd: '30. listopadu'
  },
